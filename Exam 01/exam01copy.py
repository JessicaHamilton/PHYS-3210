...
def old_cherry(N):
    ...
    #Here we are assuming that the function is focused of the probability one person and there is 
    # one cherry tree and basket per person. With the old version, the area of the triangles for 
    #each spin is not equal. The first four triangles are equal in area and have equal proability of
    #begin picked by the spinner "finger" so to speak. The next three triangles also have the same
    #area as each other but are half as big as the first four and therefore have a lower
    #probability of being picked. So In my function, I am setting the weight approxilately to be a 4:3
    #ratio where the first four will have a 4:7 probability and the last three will have a 3:7 probability.
    Cherry_tree = 10
    Basket = 0
    turns_played = 1
